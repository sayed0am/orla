...
Deploys Orla into your own Cloudflare and OpenRouter accounts in one command. See [docs/INSTALL.md](docs/INSTALL.md) for prerequisites, what it provisions, costs, updating, and uninstalling.
